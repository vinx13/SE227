...
yfs_client=yfs_client.cc extent_client.cc fuse.cc extent_server.cc inode_manager.cc version.cc disk.cc
ifeq ($(LAB3GE),1)
...
extent_server=extent_server.cc extent_smain.cc inode_manager.cc version.cc disk.cc
